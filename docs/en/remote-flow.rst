...
Depending on whether the User is using a mobile device or a workstation, the Relying Party MUST support the following remote flows (:ref:`RPR-84 <test-plans-remote-presentation:RPR-84>`):
...
.. warning::
  ...
  Relying Party, MUST NOT include any User information or other explicit (:ref:`RPR-86 <test-plans-remote-presentation:RPR-86>`)
  information regarding the hardware used or usage preferences of its User (:ref:`RPR-86 <test-plans-remote-presentation:RPR-86>`).
...
.. list-table:: Wallet Metadata Parameters
   ...
   * - `response_types_supported`
     - OPTIONAL. JSON array of OAuth 2.0 ``response_type`` values. If present it MUST be set to ``vp_token`` (:ref:`RPR-82 <test-plans-remote-presentation:RPR-82>`).
   * - `response_modes_supported`
...
.. note::
  ...
  When present, the Relying Party MUST evaluate it (:ref:`RPR-81 <test-plans-remote-presentation:RPR-81>`).
